...
System.out.println()
System.out.println("  This first example is a module named com.greetings that simply prints")
System.out.println("  \"Greetings!\". The module consists of two source files:")
System.out.println("  the module declaration (`module-info.java`) and the main class.")
System.out.println("")
System.out.println("  By convention, the source code for the module is in a directory that is")
System.out.println("  the name of the module.")
System.out.println()
