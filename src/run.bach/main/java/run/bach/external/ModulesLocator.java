...
@FunctionalInterface
public interface ModulesLocator {
  ...
  static ModulesLocator ofProperties(Path file) {
  ...
  record PropertiesLocator(String description, Properties properties) implements ModulesLocator {
    @Override
