...
class build {
  ...
  static Project project() {
    ...
    var version = ModuleDescriptor.Version.parse("9");
            ...
            DeclaredModuleFinder.of(
                new DeclaredModule(
                    ...
                    SourceFolders.of(
                        ...
                        SourceFolder.of(foo.resolve("main/java-11")),
                        SourceFolder.of(foo.resolve("main/java-15"))),
                    SourceFolders.of(
                        SourceFolder.of(foo.resolve("main/java")),
                        SourceFolder.of(foo.resolve("main/java-11")),
                        SourceFolder.of(foo.resolve("main/java-15")),
                        SourceFolder.of(foo.resolve("main/resources")),
                        SourceFolder.of(foo.resolve("main/resources-11")),
                        SourceFolder.of(foo.resolve("main/resources-13"))))),
