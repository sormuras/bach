...
function determine_url() {
    ...
    case "${feature}-${license}" in
       ...
       11-GPL) url="${DOWNLOAD}/GA/jdk11/7/GPL/openjdk-11.0.2_${os}_bin.tar.gz"; return;;
       11-BCL) url="${ORACLE}/11.0.2+7/f51449fcd52f4d52b93a989c5c56ed3c/jdk-11.0.2_${os}_bin.tar.gz"; return;;
    esac
